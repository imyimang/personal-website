...
const SocialBox = () => {
  return (
    <div className="bg-white rounded-lg shadow-2xl p-5 w-full max-w-5/6 h-40 mx-auto flex justify-around items-center px-10 experience-box transition-transform duration-300 hover:scale-110">
      <a
