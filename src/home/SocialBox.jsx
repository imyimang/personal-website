...
const SocialBox = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl p-5 w-full sm:max-w-[83.333%] h-40 mx-auto flex flex-col justify-between items-center transition-transform duration-400 hover:scale-110 border border-black">
      {/* 社交媒體圖標區域 */}
