...
const SocialBox = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl p-5 w-full max-w-[83.333%] h-40 mx-auto flex justify-around items-center px-10 transition-transform duration-400 hover:scale-110">
      <a
